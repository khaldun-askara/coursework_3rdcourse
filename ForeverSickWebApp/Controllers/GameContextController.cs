...
namespace ForeverSickWebApp.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class GameContextController : ControllerBase
    {
        ...
        // это попытки читать из конфига, которые увенчались ����������������������������
        // было вылечено сохранением с ютф8
        string DataSource => configuration["ConnectionStrings:DB"];
        ...
        public ActionResult RandomDiagnosis(int сategory_id)
        {
            ...
            using (SQLiteConnection Connect = new SQLiteConnection(DataSource))
            {
                ...
                SQLiteParameter сategoryParam = new SQLiteParameter("@parent_id", сategory_id);
        ...
        public string Questions(int diagnosis_id)
        {
            ...
            using (SQLiteConnection Connect = new SQLiteConnection(DataSource))
            {
                ...
                SQLiteParameter diagnosisParam = new SQLiteParameter("@diagnosis_id", diagnosis_id);
        ...
        public string DiagnosesBySubstring(string substring)
        {
            ...
            using (SQLiteConnection Connect = new SQLiteConnection(DataSource))
            {
                ...
                Command.Parameters.Add("@upper_substring", System.Data.DbType.AnsiString).Value = substring;
                Command.Parameters.Add("@lower_substring", System.Data.DbType.AnsiString).Value = substring.ToLower();
                using (SQLiteDataReader sqlReader = Command.ExecuteReader())
                    while (sqlReader.Read())
                    {
                        Diagnosis diagnosis = new Diagnosis(sqlReader.GetInt32(0), sqlReader.GetString(1), sqlReader.GetString(2));
        ...
        //        };
        //        SQLiteParameter category_idParam = new SQLiteParameter("@category_id", category_id);
        ...
        public ActionResult AnswerOnQuestion(int diagnosis_id, int question_id)
        {
            ...
            using (SQLiteConnection Connect = new SQLiteConnection(DataSource))
            {
                ...
                SQLiteParameter diagnosisParam = new SQLiteParameter("@diagnosis_id", diagnosis_id);
                SQLiteParameter questionParam = new SQLiteParameter("@question_id", question_id);
                Command.Parameters.Add(diagnosisParam);
        ...
        public string AnswerOnEnumAnalysis(int diagnosis_id, int indicator_id)
        {
            ...
            using (SQLiteConnection Connect = new SQLiteConnection(DataSource))
            {
                ...
                SQLiteParameter diagnosisParam = new SQLiteParameter("@diagnosis_id", diagnosis_id);
                SQLiteParameter indicatorParam = new SQLiteParameter("@indicator_id", indicator_id);
                Command.Parameters.Add(diagnosisParam);
        ...
        public int PostGameResult(Request request/*int player_id, int right_diagnosis_id, int given_diagnosis_id*/)
        {
            ...
            using (SQLiteConnection Connect = new SQLiteConnection(DataSource))
            {
                ...
                SQLiteParameter playerParam = new SQLiteParameter("@player_id", request.player_id);
                SQLiteParameter right_diagnosisParam = new SQLiteParameter("@right_diagnosis", request.right_diagnosis_id);
                SQLiteParameter given_diagnosisParam = new SQLiteParameter("@given_diagnosis", request.given_diagnosis_id);
        ...
        public ActionResult Suggestion(Body body)
        {
            ...
            using (SQLiteConnection Connect = new SQLiteConnection(DataSource))
            {
                ...
                Command.Parameters.Add("@diagnosis_id", System.Data.DbType.Int32).Value = body.id;
                Command.Parameters.Add("@symptoms", System.Data.DbType.AnsiString).Value = body.simptoms;
                Command.Parameters.Add("@visible_signs", System.Data.DbType.AnsiString).Value = body.visuals;
                Command.Parameters.Add("@questions_and_answers", System.Data.DbType.AnsiString).Value = body.questions;
                res = Command.ExecuteNonQuery();
                Connect.Close();
            }
            return Ok(res);
        ...
        public int DiagnosisQuestionAnswer (answers_questions_for_diagnosesString request/*int diagnosis_id, int question_id, int answer_id*/)
        {
            ...
            using (SQLiteConnection Connect = new SQLiteConnection(DataSource))
            {
                ...
                SQLiteParameter diagnosis_idParam = new SQLiteParameter("@diagnosis_id", request.diagnosis_id);
                SQLiteParameter question_idParam = new SQLiteParameter("@question_id", request.question_id);
                SQLiteParameter answer_idParam = new SQLiteParameter("@answer_id", request.answer_id);
